...
class TestQueryGeometFeatureInfo:
    ...
    async def test_builds_correct_url(self):
        ...
        assert "BBOX=44.780,-75.070,46.780,-73.070" in captured_url
...
class TestParseEcCityFeatures:
    def test_parses_standard_features(self):
        ...
        features = [
            {
                "id": "qc-68",
                "properties": {
                    "name": {"en": "Saint-Jerome", "fr": "Saint-Jérôme"},
                    "url": {
                        "en": "https://weather.gc.ca/city/pages/qc-68_metric_e.html?coords=45.78,-74.00"
                    },
                },
            },
            {
        ...
        assert len(result) == 2
        assert result[0]["id"] == "qc-68"
        assert result[0]["name"] == "Saint-Jerome"
        assert result[0]["province"] == "QC"
        assert result[0]["lat"] == 45.78
        assert result[0]["lon"] == -74.00
    ...
    def test_french_language(self):
        ...
        assert result[0]["name"] == "Saint-Jérôme"
        ...
        features = [
            {
                ...
                "properties": {
                    "name": "Saint-Jerome",
                    "url": {"en": "https://example.com?coords=45.78,-74.00"},
                },
            },
        ]
