...
/**
 * Resolve the image reference for a version tag. "stable" is the standard
 * target — latest stable HA is the only supported version (no pinning);
 * arbitrary tags stay accepted for run.mjs's local --ha-version override.
 */
